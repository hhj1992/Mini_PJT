...
<%
	...
	//hashmap map을 생성해서 거기에다가 req의 "map"을 담아
	...
	if(total > 0) {   	
		totalPage= total / searchVO.getPageUnit() ; // 총 데이터의 로우수가 10다. 내가 한번에 보여줄 수 있는 로우수 3개. 총 4개의 창이 필요하다.		
	...
	<tr class="ct_list_pop">
		...
		<% if(vo.getProTranCode().equals("0")){%>
			...
			<%}else if(vo.getProTranCode().equals("1")){%>
							구매완료 <a href="/updateTranCode.do?tran_no=<%=vo.getTransNo()%>">[배송하기]</a>
