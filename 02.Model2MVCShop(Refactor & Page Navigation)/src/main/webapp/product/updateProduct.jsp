		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<td class="ct_write01"><input type="text" name="prodDetail"
					value="<%=product.getProdDetail()%>" class="ct_input_g"
			...
			<tr>
				...
				<td class="ct_write01">
					...
					name="manuDate" value="<%=product.getManuDate()%>" class="ct_input_g"
					style="width: 100px; height: 19px" maxLength="10" minLength="6">&nbsp;
			...
			<tr>
				...
				<td class="ct_write01"><input type="text" name="price"
					value="<%=product.getPrice()%>" class="ct_input_g"
			...
			<tr>
				...
				<input type="text" name="fileName"
					...
					maxLength="13" value="<%=product.getFileName()%>" /></td>
			</tr>
			<tr>
				<td height="1" colspan="3" bgcolor="D6D6D6"></td>
			</tr>
