...
public class LogonCheckInterceptor extends HandlerInterceptorAdapter {
	...
	public boolean preHandle(HttpServletRequest request,HttpServletResponse response, Object handler) throws Exception {
		...
		if(   user != null   )  {
			...
			String urrr = "rkskek"+uri;
			System.out.println("uri :: "+urrr);
			System.out.println(uri.indexOf("getUser"));
			...
			if(		uri.indexOf("addUserView") != -1 	|| 	uri.indexOf("addUser") != -1 || 
				...
				//uri의 String이 addUserView, addUser, loginView, login, checkDuplication -1이 아닐때. -1이 아니라는것은 uri에 포함되어있다는 것. 해당된다는 것. 
