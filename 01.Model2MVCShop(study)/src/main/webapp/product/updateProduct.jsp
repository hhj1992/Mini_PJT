		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<td class="ct_write01"><input type="text" name="prodDetail"
					value="<%=productVO.getProdDetail()%>" class="ct_input_g"
			...
			<tr>
				...
				<td class="ct_write01">
					...
					name="manuDate" value="<%=productVO.getManuDate()%>" class="ct_input_g"
					style="width: 100px; height: 19px" maxLength="10" minLength="6">&nbsp;
			...
			<tr>
				...
				<td class="ct_write01"><input type="text" name="price"
					value="<%=productVO.getPrice()%>" class="ct_input_g"
			...
			<tr>
				...
				<input type="text" name="fileName"
					...
					maxLength="13" value="<%=productVO.getFileName()%>" /></td>
			</tr>
			<tr>
				<td height="1" colspan="3" bgcolor="D6D6D6"></td>
			</tr>
